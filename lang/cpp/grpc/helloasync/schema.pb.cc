...
const ::uint32_t
    TableStruct_schema_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::helloasync::HelloRequest, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::helloasync::HelloRequest, _impl_.name_),
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::helloasync::HelloResponse, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ~0u,  // no _weak_field_map_
        ~0u,  // no _inlined_string_donated_
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::helloasync::HelloResponse, _impl_.message_),
};

static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, -1, sizeof(::helloasync::HelloRequest)},
        {9, -1, -1, sizeof(::helloasync::HelloResponse)},
};
static const ::_pb::Message* const file_default_instances[] = {
    &::helloasync::_HelloRequest_default_instance_._instance,
    &::helloasync::_HelloResponse_default_instance_._instance,
};
const char descriptor_table_protodef_schema_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    ".helloasync.HelloRequest\032\031.helloasync.He"
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:helloasync.HelloRequest)
}
inline PROTOBUF_NDEBUG_INLINE HelloRequest::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::helloasync::HelloRequest& from_msg)
...
HelloRequest::HelloRequest(
  ...
  // @@protoc_insertion_point(copy_constructor:helloasync.HelloRequest)
}
inline PROTOBUF_NDEBUG_INLINE HelloRequest::Impl_::Impl_(
...
HelloRequest::~HelloRequest() {
  // @@protoc_insertion_point(destructor:helloasync.HelloRequest)
  SharedDtor(*this);
}
...
const ::_pbi::TcParseTable<0, 1, 0, 36, 2> HelloRequest::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::helloasync::HelloRequest>(),  // to_prefetch
  ...
  {{
    "\27\4\0\0\0\0\0\0"
    "helloasync.HelloRequest"
    "name"
  }},
};

PROTOBUF_NOINLINE void HelloRequest::Clear() {
// @@protoc_insertion_point(message_clear_start:helloasync.HelloRequest)
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* HelloRequest::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(serialize_to_array_start:helloasync.HelloRequest)
          ::uint32_t cached_has_bits = 0;
          (void)cached_has_bits;
          ...
          if (!this_._internal_name().empty()) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "helloasync.HelloRequest.name");
          ...
          // @@protoc_insertion_point(serialize_to_array_end:helloasync.HelloRequest)
          return target;
        }
        ...
        ::size_t HelloRequest::ByteSizeLong() const {
          const HelloRequest& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(message_byte_size_start:helloasync.HelloRequest)
          ::size_t total_size = 0;
...
void HelloRequest::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:helloasync.HelloRequest)
...
// @@protoc_insertion_point(class_specific_copy_from_start:helloasync.HelloRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:helloasync.HelloResponse)
}
inline PROTOBUF_NDEBUG_INLINE HelloResponse::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::helloasync::HelloResponse& from_msg)
...
HelloResponse::HelloResponse(
  ...
  // @@protoc_insertion_point(copy_constructor:helloasync.HelloResponse)
}
inline PROTOBUF_NDEBUG_INLINE HelloResponse::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* arena)
...
HelloResponse::~HelloResponse() {
  // @@protoc_insertion_point(destructor:helloasync.HelloResponse)
  SharedDtor(*this);
}
...
const ::_pbi::TcParseTable<0, 1, 0, 40, 2> HelloResponse::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::helloasync::HelloResponse>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    // string message = 1;
    {::_pbi::TcParser::FastUS1,
  ...
  {{
    "\30\7\0\0\0\0\0\0"
    "helloasync.HelloResponse"
    "message"
  }},
};

PROTOBUF_NOINLINE void HelloResponse::Clear() {
// @@protoc_insertion_point(message_clear_start:helloasync.HelloResponse)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* HelloResponse::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(serialize_to_array_start:helloasync.HelloResponse)
          ::uint32_t cached_has_bits = 0;
          (void)cached_has_bits;
          ...
          if (!this_._internal_message().empty()) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "helloasync.HelloResponse.message");
            target = stream->WriteStringMaybeAliased(1, _s, target);
          }
          ...
          // @@protoc_insertion_point(serialize_to_array_end:helloasync.HelloResponse)
          return target;
        }
        ...
        ::size_t HelloResponse::ByteSizeLong() const {
          const HelloResponse& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(message_byte_size_start:helloasync.HelloResponse)
          ::size_t total_size = 0;
...
void HelloResponse::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:helloasync.HelloResponse)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:helloasync.HelloResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
