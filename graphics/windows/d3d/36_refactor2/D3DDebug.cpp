...
std::map<D3D12_MESSAGE_CATEGORY, std::wstring> D3DDebug::m_categoryMap = {
...
std::map<D3D12_MESSAGE_SEVERITY, std::wstring> D3DDebug::m_severityMap = {
...
void D3DDebug::enableDebugLayer()
{
...
void D3DDebug::setupCallback(const Microsoft::WRL::ComPtr<ID3D12Device>& device)
{
...
void D3DDebug::cleanup(const Microsoft::WRL::ComPtr<ID3D12Device>& device) const
{
