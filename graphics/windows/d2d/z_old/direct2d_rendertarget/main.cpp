...
public:
        ...
        ptMouse(D2D1::Point2F())
    {
        ...
        //     D2D1::Point2F((rc.right - rc.left) / 2.0f, (rc.bottom - rc.top) / 2.0f),
        //     (rc.right - rc.left) / 4.0f, // 1/4 of width
        //     (rc.bottom - rc.top) / 4.0f  // 1/4 of height
        // );
        ellipse = D2D1::Ellipse(
...
void MainWindow::CalculateLayout()
{
    ...
    // ellipse.point.x = (rc.right - rc.left) / 2.0f;
    // ellipse.point.y = (rc.bottom - rc.top) / 2.0f;
    ellipse.point.x = 120.0f; // Center X
    ellipse.point.y = 120.0f; // Center Y

    // ellipse.radiusX = (rc.right - rc.left) / 4.0f; // 1/4 of width
    // ellipse.radiusY = (rc.bottom - rc.top) / 4.0f; // 1/4 of height
}
...
{
    std::cout << "0x" << std::hex << uMsg << std::endl;
    switch (uMsg)
    {
    case WM_CREATE:
    ...
    case WM_SIZE:
        // std::cout << "WM_SIZE received" << std::endl;
        // Resize();
        return 0;
    }
